...
private val BUKKIT_AUDIENCES = DestroyBlock.bukkitAudiences
 ...
 */
fun sendMessage(player: Player, message: String) = BUKKIT_AUDIENCES.player(player).sendMessage(Component.text(message))
 ...
 * @param message String that will be send to the player
 */
fun sendMessageClean(player: Player, message: String) = player.sendMessage(message)
